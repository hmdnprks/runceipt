...
const s: Record<string, React.CSSProperties> = {
  ...
  btn: { background: "none", border: "1px solid #333", color: "#888", padding: "10px 20px", borderRadius: "4px", cursor: "pointer", fontFamily: "'Courier New', monospace", fontSize: "12px", marginTop: "8px" },
};
